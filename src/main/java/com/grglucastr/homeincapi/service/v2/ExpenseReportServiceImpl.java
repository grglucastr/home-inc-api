...
public class ExpenseReportServiceImpl implements ExpenseReportService {
    ...
    @Override
    public SingleSummaryResponse generateSingleSummaryReport(List<Expense> expenses, int year, int monthNo) {
        final String monthlyProgress = DateUtils.getMonthlyProgress(year, monthNo);
        final SingleSummaryResponse summaryResponse = new SingleSummaryResponse();
